...
void main() {
  ...
  testWidgets(
      'Saving user will call repository successfully',
  ...
  testWidgets(
      'Updating user will call repository successfully',
      (WidgetTester tester )async {
       when(() => mockRepo.saveMyUser(any(), null)).thenAnswer((_) async {});
  ...
  testWidgets(
      'When is a new user delete button is not visible',
          (WidgetTester tester) async {
        await tester.pumpWidget(getMaterialApp());
        await tester.pumpAndSettle();
  ...
  testWidgets(
      'When is an  editing user delete button is visible',
          (WidgetTester tester) async {
        await tester.pumpWidget(getMaterialApp(arguments: _myUser1));
        await tester.pumpAndSettle();
  ...
  testWidgets(
      'Delete an editing user will call repository successfully',
          (WidgetTester tester) async {
